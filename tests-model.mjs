...
STATE.scenarioVersions={Budget:deepClone(STATE)}; getRow(STATE.scenarioVersions.Budget.growthEngines.find(b=>b.title.startsWith('Ecommerce')).rows,'GM1 %').y2027='50%'; applyApprovedEcommerceGm1PathEverywhere(); assert.equal(getRow(STATE.scenarioVersions.Budget.growthEngines.find(b=>b.title.startsWith('Ecommerce')).rows,'GM1 %').y2027,'37%');
